// ignore_for_file: prefer_const_constructors, sized_box_for_whitespace, prefer_const_literals_to_create_immutables, unused_field, prefer_final_fields, override_on_non_overriding_member, unnecessary_new, use_full_hex_values_for_flutter_colors, prefer_equal_for_default_values
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        // dots
        GetBuilder<PopulerProductController>(builder: (popularProduct) {
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    SmallText(
                                        text:
                                            "With Delhi Darbaar characterstics"),
                                    SizedBox(
                                      height: Dimensions.height10,
                                    ),
                                    Row(
